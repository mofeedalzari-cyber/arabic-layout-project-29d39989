...
- `www/index.html` — شاشة تشغيل محلية تفتح الموقع وتمنع صفحة `ERR_FAILED`
- `www/offline.html` — شاشة استعادة محلية مع إعادة محاولة تلقائية عند تعثر الاتصال
...
الموقع مربوط بـ **Render** من خلال شاشة تشغيل محلية داخل الـAPK، لذلك أي تحديث تعمله في Lovable سيظهر تلقائياً داخل التطبيق **بدون إعادة بناء APK** ✨
...
2. **الاتصال بالإنترنت مطلوب لجلب أحدث البيانات** — عند تعثر الاتصال تظهر شاشة محلية بدل خطأ Android وتعيد المحاولة تلقائياً.

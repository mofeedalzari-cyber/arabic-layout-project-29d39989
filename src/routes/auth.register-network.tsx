...
export const Route = createFileRoute("/auth/register-network")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: `${SITE_URL}/auth/register-network` },
    ],
    links: [{ rel: "canonical", href: `${SITE_URL}/auth/register-network` }],
  }),
});
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <TypeCard
                active={false}
                onClick={() => navigate({ to: "/auth/register-agent" })}
